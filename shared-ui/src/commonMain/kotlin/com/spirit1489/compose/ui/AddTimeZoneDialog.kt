...
import com.spirit1489.compose.ui.OnAddType
import com.spirit1489.compose.ui.onDismissType
import com.spirit1489.findtime.TimeZoneHelper
import com.spirit1489.findtime.TimeZoneHelperImpl
...
fun searchZones(searchString: String, timeZoneStrings: List<String>): Int {
    var timezone =
        timeZoneStrings.firstOrNull { it.startsWith(searchString, ignoreCase = true) }
    if (timezone == null) {
